...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final List<Privilege> managerPrivileges = new ArrayList<>(Arrays.asList(readPrivilege, passwordPrivilege, managementPrivilege));
        ...
        // == create initial standard user
        createUserIfNotFound("test_user@test.com", "Test", "User", "test_user", new ArrayList<>(Arrays.asList(userRole)));
        // == create initial manager user
        createUserIfNotFound("test_manager@test.com", "Test", "Manager", "test_manager", new ArrayList<>(Arrays.asList(managerRole)));
